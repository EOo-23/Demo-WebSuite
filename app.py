...
STAGES = {
    "Fresa": ["Preplantacion", "Plantacion", "Crecimiento", "Cumplimiento de pedido", "Cosecha", "Postcosecha", "Mercancias en transito", "Capex", "Overhead"],
    "Invernadero": ["Preplantacion", "Plantacion", "Crecimiento", "Cumplimiento de pedido", "Cosecha/Postcosecha", "Mercancias en transito", "Capex", "Overhead"],
    "Administracion": ["Gastos de administracion", "Opex", "Capex", "SCC"]
}
